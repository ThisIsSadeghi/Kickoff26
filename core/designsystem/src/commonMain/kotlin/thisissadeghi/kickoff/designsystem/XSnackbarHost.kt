...
/**
 * This class is based on [androidx.compose.material.SnackbarHost]
 * only [toMillis] is modified and showing time is reduced
 */
@Composable
fun XSnackbarHost(
...
internal fun SnackbarDuration.toMillis(hasAction: Boolean): Long {
    val original =
        when (this) {
            SnackbarDuration.Indefinite -> Long.MAX_VALUE
            SnackbarDuration.Long -> 1200L
            SnackbarDuration.Short -> 500L
        }
