...
fun MoneyText(
    ...
    val defaultFontSize = fontSize.takeOrElse { style.fontSize }

    Text(
        text =
            buildAnnotatedString {
                if (currency != null) {
                    withStyle(SpanStyle(fontSize = defaultFontSize * 0.7f)) {
                        append(currency.symbol)
                    }
                    withStyle(SpanStyle(fontSize = defaultFontSize * 0.2f)) {
                        append(" ")
                    }
                }
